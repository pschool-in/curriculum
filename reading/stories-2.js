  ...
  list: [
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: 'This story is about __________ of doves.',
            options: 'a flight, a flock, a swarm, a pack'
          },
          {
            qText: 'Who laid the net to catch the doves?',
            options: 'hunter, villagers, farmer'
          },
          {
          ...
          },
          {
            ...
            options: 'astonishment, accomplishment, acknowledgement'
          },
          {
            qText: 'The doves flew to a ______ for help.',
            options: 'mouse, rat, rabbit, snake'
          },
          {
            qText: 'What is the learning from the story?',
            options: `If we work together, we can solve our problems.
              Beware of hunters.
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: 'Who lost the ring?',
            options: 'Akbar, Birbal, Ashoka'
          },
          {
            qText: 'Who helped the king to find the ring?',
            options: 'Birbal, Akbar, Ashoka'
          },
          {
            qText: 'Where did the story take place?',
            options:
          ...
          },
          {
            ...
            options: 'scared, happy, sad, smart'
          },
          {
            qText: 'Birbal is known for his __________.',
            options: 'wisdom, wealth, cunningness'
          }
        ]
      }
    },
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: 'Who is capable of running fast?',
            options: 'turtle, * rabbit, both are fast, both are slow'
          },
          {
            qText: 'Which of the below statement is correct?',
            options: `The rabbit was making fun on the turtle.
            The turtle was making fun on the rabbit.
            The rabbit was praising the turtle.
            The turtle was praising the rabbit.`
          },
          {
            qText: 'The turtle walked past the sleeping rabbit _______.',
            options: 'silently, joyfully, noisily, funnily'
          },
          {
            qText: 'Who won the race?',
            options: 'turtle, rabbit, fox, no one'
          },
          {
            qText: "What was the rabbit's mistake?",
            options: `It slept in the middle of the race.
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: 'How many frogs fell into a deep pit?',
            options: 'Two, Three , Five, One'
          },
          {
            qText: 'What did the other frogs tell the frogs in the pit?',
            options: `It is not possible to get out of it.
            Take rest and try to come up tomorrow.
            Try hard to come up.`
          },
          {
            qText: 'What happened when the other frogs shouted?',
            options: `Both the frogs tried to come up.
              * One frog gave up.
              * One frog tried to come up.
              Both the frogs gave up`
          },
          {
            qText: 'How many frogs managed to come up?',
            options: 'one, two, none'
          },
          {
            qText: 'The frog that came out was _______.',
            options: 'deaf, blind, dumb'
          }
        ]
      }
    },
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: 'When did this story take place?',
            options:
              'On a summer night, On a rainy day, On a summer noon, On a winter evening'
          },
          {
            qText: 'The thieves were hiding ______.',
            options:
