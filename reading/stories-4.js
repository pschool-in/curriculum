  ...
  list: [
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: "Who was the fourth friend to join?",
            options: "A turtle, A crow, A deer, A mouse",
          },
          {
            qText: "What was the hunter's main target?",
            options: "deer, turtle, crow, mouse",
          },
          {
            qText: "Who freed the turtle from the nets?",
            options: "mouse, deer, turtle, crow",
          },
          {
            qText: "In what way, the crow helped to rescue the turtle?",
            options: `It flew high and spotted the location of the hunter.
              It did not help.
              It helped by making lot of noise.`,
          },
          {
            qText: "At the end of the story, the hunter was _______.",
            options: "disappointed, angry, happy, tired",
          },
        ],
      },
    },
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: "To whom did the merchant give his ancestral property?",
            options:
              "To his friend, To his servant, To his neighbor, To his relative",
          },
          {
            qText: "Why did the merchant leave his village?",
            options: `Due to heavy loss in his business
          ...
          },
          {
            ...
            options: `He said that mice ate the iron balance.
              He said that he lost the iron balance.
              He honestly returned the iron balance.`,
          },
          {
            qText: "True or False: Mice can eat an iron balance.",
            options: "False, True",
          },
          {
            qText: "True or False: Vulture cannot carry a grown up boy.",
            options: "True, False",
          },
          {
            qText: "Who was selfish and tried to cheat in this story?",
            options: "Ravi, Merchant, Judge, Boy",
          },
        ],
      },
    },
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: "From whom did the farmer buy the well?",
            options: "Iqbal Khan, Akbar, Birbal",
          },
          {
            qText: "Why did the farmer bought the well?",
            options: "For irrigation, For drinking, For washing",
          },
          {
            qText: "What was Iqbal's statement in the court?",
            options: `He sold only the well and not the water in it.
            He didn't sell the well.
            He didn't get the money from the farmer.`,
          },
          {
            qText: "Whom did the farmer approach for justice?",
            options: "Akbar, Birbal, Court",
          },
          {
            qText: "How did Birbal solved the case?",
            options: `He asked Iqbal to pay rent for water.
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: "What did the travellers carry?",
            options: `An empty cooking pot.
            A pot full of food.
            A bag full of clothers.
            They did not carry anything.`,
          },
          {
            qText: "How did the villagers reacted to the travellers?",
            options: `The villagers did not share food with them.
            The villagers did not allow them inside their village.
            The villagers shared their food.`,
          },
          {
            qText: "What was the first ingredient added to the soup?",
            options: "A large stone, A pinch of salt, Carrot",
          },
          {
            qText: "The travellers prepared the soup using ________.",
            options:
              "the ingredients supplied by the villagers, the stone, black magic",
          },
          {
            qText: "How did the villagers felt at the end?",
            options:
              "They were happy., They were sad., They were angry., They were disappointed.",
          },
        ],
      },
    },
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: "Where did the man climb?",
            options: "A tree, A hill, A building,  A ladder",
          },
          {
            qText: "The man was sad because ______ .",
            options: `he didn't know how to climb down
          ...
          },
          {
            ...
            options: `They gathered around the tree and tried to help.
              They scolded the man for climbing the tree.
              They waited for Mulla to come and help.
              They ran away.`,
          },
          {
            qText: "Who came forward to help the man?",
            options: "Mulla, Birbal, Tenali",
          },
          {
            qText: "What did Mulla take to bring the man down?",
            options: "A rope, A ladder, An Axe, A piece of cloth",
          },
          {
            qText: "What was the result of Mulla's attempt?",
