export default {
  misery: {
    ...
    eg: `The refugee's life was filled with *misery* as they struggled to find safety and stability.
She couldn't hide her *misery* when her favorite book was lost.`,
  ...
  moisture: {
    ...
    eg: `The *moisture* on the window indicated a humid day.
To keep the skin hydrated, it's important to use a moisturizer that locks in *moisture*.`,
  ...
  mural: {
    ...
    eg: `The artist spent weeks working on a stunning *mural* that covered an entire wall of the art gallery.
The *mural* on the side of the building depicted a colorful jungle scene.`,
  ...
  mystify: {
    ...
    eg: `The magician made the rabbit disappear. It *mystified* the audience.
The cryptic message in the old book continued to *mystify* researchers for years.`,
  ...
  nectar: {
    ...
    eg: `The sweet *nectar* of the flowers attracted a variety of colorful butterflies.
The bees diligently collected *nectar* from the blossoms to make honey.`,
  ...
  observe: {
    ...
    eg: `Birdwatchers often spend hours in the park to *observe* different bird species in their natural habitat.
...
He survived the *ordeal* and eventually wrote a book about it.`,
  ...
  origin: {
    ...
    eg: `The *origin* of the ancient artifact was traced back to a lost civilization.
Understanding the *origin* of a word can provide insight into its meaning and usage.`,
  ...
  outcome: {
    ...
    eg: `The *outcome* of the negotiation was a mutually beneficial agreement for both parties.
The success of a project often depends on the effort put into achieving a favorable *outcome*.`,
  ...
  pastime: {
    ...
    eg: `Reading is a beloved *pastime* for many people, allowing them to escape into different worlds.
Playing board games is a popular *pastime* for families, promoting quality time together.`,
  ...
  pause: {
    ...
    eg: `The music conductor signaled for a brief *pause* before the orchestra continued playing.
Take a moment to *pause* and reflect on your goals before making a decision.`,
  ...
  perform: {
    meaning: 'get done',
    eg: `The talented musician was set to *perform* a concert in front of a large audience.
The surgical team worked tirelessly to *perform* a life-saving operation.`,
  ...
  plunge: {
    ...
    eg: `The thrill-seekers decided to *plunge* into the icy waters of the mountain lake.
The village girls are not afraid to *plunge* into the well. They are great swimmers.`,
  ...
  predator: {
    ...
    eg: `Lions are known as fierce *predators* in the African savanna, hunting for their prey.
The bird of prey is a skilled *predator*, soaring high in the sky in search of small animals.`,
  ...
  predict: {
    ...
    eg: `Meteorologists use advanced technology to *predict* the weather, helping people prepare for storms.
Experts try to *predict* the economic trends based on various factors and data.`,
  ...
  prevent: {
    ...
    eg: `Regular exercise and a healthy diet can help *prevent* many common health issues.
The security measures in place are designed to *prevent* unauthorized access to the building.`,
  ...
  primary: {
    meaning: 'important',
    eg: `Education is a *primary* focus in a child's development, setting the foundation for future success.
The *primary* goal of the project was to reduce carbon emissions and promote sustainability.`,
  ...
  privilege: {
    ...
    eg: `Having access to quality education is a *privilege* that not everyone in the world enjoys.
Being able to travel and explore new cultures is a *privilege* that broadens one's perspective.`,
  ...
  process: {
    ...
    eg: `The manufacturing *process* involves multiple stages, from design to production.
Cooking a meal requires following a specific *process* of chopping, seasoning, and cooking.`,
  ...
  rare: {
    ...
    eg: `The *rare* gemstone found in the cave was one of the most valuable discoveries in years.
A *rare* astronomical event, like a solar eclipse, is a captivating sight.`,
  ...
  recall: {
    ...
    eg: `She struggled to *recall* the name of the book she read years ago but could remember the plot.
The car manufacturer issued a *recall* of a certain model due to a safety concern.`,
  ...
  rely: {
    ...
    eg: `In times of need, you can *rely* on your close friends to provide support.
Businesses *rely* on customer feedback to improve their products and services.`,
  ...
  remark: {
    ...
    eg: `His *remark* during the meeting sparked a thoughtful discussion among the team members.
She made a humorous *remark* that lightened the mood in the room.`,
  ...
  resident: {
    ...
    eg: `The *resident* of the neighborhood organized a community clean-up event to improve the area.
A *resident* of the town for over 30 years, he had witnessed many changes over time.`,
  ...
  respect: {
    ...
    eg: `It's important to *respect* other people's opinions and values, even if they differ from your own.
...
The movie's plot took an unexpected *reverse* in the final act, surprising the audience.`,
  ...
  revive: {
    ...
    eg: `The quick administration of CPR helped to *revive* the unconscious swimmer at the pool.
A good night's sleep can help you *revive* your energy and mental alertness.`,
  ...
  risk: {
    ...
    eg: `Investing in the stock market carries a certain level of financial *risk* due to market fluctuations.
Crossing a busy street without using the crosswalk is a dangerous *risk* to one's safety.`,
  ...
  scatter: {
    ...
    eg: `The strong wind caused the leaves to *scatter* in all directions, creating a colorful spectacle.
The children were told not to *scatter* their toys all over the living room.`,
  ...
  schedule: {
    ...
    eg: `I have a busy *schedule* this week, with meetings and deadlines every day.
The school's *schedule* includes classes in the morning and extracurricular activities in the afternoon.`,
  ...
  sensitive: {
    ...
    eg: `Some people have *sensitive* skin that may react to certain skincare products.
It's crucial to be *sensitive* to the feelings of others and avoid hurtful comments.`,
  ...
  signal: {
    ...
    eg: `The traffic light changed from red to green, giving the *signal* for the cars to proceed.
Nonverbal *signals*, like body language, can convey important messages in a conversation.`,
  ...
  solution: {
    ...
    eg: `The scientist worked tirelessly to find a *solution* to the environmental problem.
The *solution* to the puzzle required careful thought and creativity.`,
  ...
  spoil: {
    ...
    eg: `Leaving food out in the sun can cause it to *spoil* quickly, making it unsafe to eat.
It's important not to *spoil* children with excessive gifts, as it may lead to entitlement.`,
  ...
  starve: {
    ...
    eg: `In times of famine, people may *starve* due to the scarcity of food.
The decision to *starve* themselves in protest drew attention to the hunger strike.`,
  ...
  steer: {
    ...
    eg: `Parents often *steer* their children toward positive life choices through guidance and support.
As the captain of the ship, he had to *steer* the vessel safely through treacherous waters.`,
  ...
  struggle: {
    ...
    eg: `The journey to overcome addiction can be a long and challenging *struggle*.
Despite the *struggle*, they persevered and achieved their goals.`,
  ...
  suitable: {
    ...
    eg: `The formal attire was *suitable* for the wedding ceremony, adhering to the dress code.
The spacious and well-lit room was *suitable* for hosting a productive business meeting.`,
  ...
  survey: {
    ...
    eg: `Researchers conducted a *survey* to gather opinions from the public on environmental issues.
The annual customer satisfaction *survey* revealed areas for improvement in the company's services.`,
  ...
  swift: {
    ...
    eg: `The *swift* response of the firefighters prevented the wildfire from spreading further.
The cheetah is known for its incredible *swift* speed in pursuit of prey.`,
  ...
  symbol: {
    ...
    eg: `The dove is often seen as a *symbol* of peace and harmony in many cultures.
The red heart is a common *symbol* of love and affection.`,
  ...
  talent: {
    ...
    eg: `The young musician displayed a remarkable *talent* for playing the piano, captivating the audience.
...
The *theory* of relativity, formulated by Albert Einstein, revolutionized the field of physics.`,
  ...
  thrill: {
    ...
    eg: `The roller coaster ride provided an adrenaline-pumping *thrill* as it sped down steep drops and sharp turns.
Achieving a long-term goal can bring a deep sense of *thrill* and accomplishment.`,
  ...
  treasure: {
    ...
    eg: `The pirate legend spoke of hidden *treasure* buried on a remote island.
The old journal contained clues to a lost family *treasure* hidden in the attic.`,
  ...
  triumph: {
    ...
    eg: `The athlete's hard work and determination led to a *triumph* in the championship race.
...
The antique vase had great *value* due to its historical significance and craftsmanship.`,
  ...
  vision: {
    ...
    eg: `Good eyesight is essential for clear *vision* and the ability to see the world around us.
The visionary leader had a grand *vision* for the future of the company.`,
  ...
  volunteer: {
    ...
    eg: `She decided to *volunteer* at the local animal shelter to help care for abandoned pets.
Many *volunteer* firefighters responded to the emergency, bravely combating the blaze.`,
  ...
  wander: {
    ...
    eg: `The hikers chose to *wander* through the forest, exploring its hidden trails and natural beauty.
When you *wander* through the city streets, you may stumble upon charming shops and cafes.`,
  ...
  wisdom: {
    ...
    eg: `With age comes *wisdom*, as life experiences teach valuable lessons.
Seeking advice from someone with *wisdom* can provide guidance in making important decisions.`,
  ...
  wit: {
    ...
    eg: `Her quick *wit* and sense of humor made her the life of the party.
The stand-up comedian's clever *wit* had the audience in stitches.`,
  ...
  woe: {
    ...
    eg: `The loss of a loved one brought deep *woe* and sorrow to the grieving family.
