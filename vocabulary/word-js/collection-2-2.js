export default {
  creative: {
    ...
    eg: `The artist's *creative* expression was evident in every stroke of the brush on the canvas.
Children often come up with *creative* solutions to problems that adults may not consider.`,
  ...
  vivid: {
    ...
    eg: `The sunset painted the sky in *vivid* shades of pink, orange, and purple.
The author used *vivid* descriptions to bring the characters and settings in the story to life.`,
  ...
  melodious: {
    ...
    eg: `The *melodious* notes of the piano filled the room, creating a serene atmosphere.
Birds in the garden sang *melodious* tunes, adding to the beauty of the surroundings.`,
  ...
  intuition: {
    ...
    eg: `Trust your *intuition*; sometimes it guides you in making the right decisions.
Her *intuition* told her that something was wrong, prompting her to investigate further.`,
  ...
  culinary: {
    ...
    eg: `The chef's *culinary* skills were showcased in the exquisite presentation and taste of the dish.
They enrolled in a *culinary* class to learn the art of preparing delicious meals.`,
    antonyms: 'non-culinary',
    synonyms: 'cooking',
    mcqs: [
      {
  ...
  fascination: {
    ...
    eg: `The astronomy book sparked his *fascination* with the stars and planets.
Her *fascination* with history led her to visit museums and read historical novels.`,
  ...
  peaceful: {
    ...
    eg: `The tranquil lake and surrounding nature created a *peaceful* retreat from the busy city life.
Meditation and deep breathing exercises can help promote a *peaceful* state of mind.`,
  ...
  strategy: {
    ...
    eg: `The military general devised a clever *strategy* to outsmart the enemy in the upcoming battle.
In chess, a well-thought-out *strategy* is essential for success.`,
  ...
  penchant: {
    ...
    eg: `She had a *penchant* for collecting antique coins, searching for rare pieces to add to her collection.
His *penchant* for adventure led him to explore uncharted territories.`,
  ...
  persistent: {
    ...
    eg: `Despite facing setbacks, her *persistent* efforts eventually led to the success of the project.
The *persistent* rain continued throughout the day, causing flooding in low-lying areas.`,
  ...
  powerful: {
    ...
    eg: `The hurricane unleashed *powerful* winds that caused widespread damage.
The speaker delivered a *powerful* message that resonated with the audience.`,
  ...
  dedication: {
    ...
    eg: `The athlete's *dedication* to training paid off when he won the championship.
Her *dedication* to the cause inspired others to join the charitable initiative.`,
  ...
  theory: {
    ...
    eg: `Scientists develop *theories* to explain natural phenomena and make predictions about the world.
In physics class, they discussed the *theory* of relativity and its implications.`,
  ...
  courage: {
    ...
    eg: `Facing the challenges of public speaking requires *courage* and confidence.
The firefighter displayed immense *courage* while rescuing people from the burning building.`,
  ...
  educational: {
    ...
    eg: `The documentary provided an *educational* perspective on the history of ancient civilizations.
*Educational* games can make learning enjoyable for children.`,
  ...
  eloquent: {
    ...
    eg: `The speaker delivered an *eloquent* speech that moved the audience to tears.
Through his *eloquent* writing, the author conveyed complex emotions with clarity.`,
  ...
  fragrant: {
    ...
    eg: `The *fragrant* aroma of blooming flowers filled the garden.
The chef added *fragrant* herbs to the dish, enhancing its flavor.`,
  ...
  priceless: {
    ...
    eg: `Family photographs are often considered *priceless*, capturing moments that hold sentimental value.
The antique necklace passed down through generations is a *priceless* family heirloom.`,
  ...
  suspenseful: {
    ...
    eg: `The *suspenseful* movie kept the audience on the edge of their seats.
The *suspenseful* atmosphere in the novel intensified with every chapter.`,
  ...
  collaboration: {
    ...
    eg: `The success of the project was a result of effective *collaboration* among team members.
Artists often find inspiration through *collaboration* with others in the creative process.`,
  ...
  profound: {
    ...
    eg: `The philosopher's teachings left a *profound* impact on the way people perceive the world.
A simple act of kindness can have a *profound* effect on someone's day.`,
  ...
  significant: {
    ...
    eg: `The discovery of a new species in the rainforest was a *significant* event for the scientific community.
The policy change had a *significant* impact on improving environmental conditions.`,
  ...
  exquisite: {
    ...
    eg: `The chef prepared an *exquisite* dessert with intricate details and rich flavors.
The artist created an *exquisite* painting, showcasing skill and attention to detail.`,
  ...
  captivating: {
    ...
    eg: `The storyteller wove a *captivating* tale that held the children's attention until the very end.
The film's *captivating* cinematography and storyline made it a box office success.`,
  ...
  vibrant: {
    ...
    eg: `The *vibrant* colors of the festival decorations filled the town with energy and joy.
In the spring, the fields come alive with *vibrant* wildflowers in full bloom.`,
    antonyms: 'dull, lifeless',
  ...
  patience: {
    ...
    eg: `Learning a new skill requires *patience* and consistent practice.
The teacher commended the students for their *patience* during the challenging assignment.`,
  ...
  cooperation: {
    ...
    eg: `Successful projects often result from effective *cooperation* and communication among team members.
The wildlife conservation efforts benefited greatly from the *cooperation* of multiple organizations.`,
  ...
  persistent: {
    ...
    eg: `Despite facing numerous challenges, her *persistent* efforts to learn a new language eventually paid off.
The *persistent* rain continued throughout the week, causing flooding in low-lying areas.`,
    antonyms: 'sporadic, occasional',
  ...
  generous: {
    ...
    eg: `Her *generous* donation to the charity helped fund essential services for those in need.
The chef was known for being *generous* with portions, ensuring customers left satisfied.`,
  ...
  curiosity: {
    ...
    eg: `Children's natural *curiosity* drives them to ask questions and explore the world around them.
The scientist's *curiosity* led to groundbreaking discoveries in the field of astronomy.`,
  ...
  reliable: {
    ...
    eg: `A *reliable* car is essential for a long road trip to ensure a smooth journey.
In the workplace, being *reliable* and meeting deadlines contributes to professional success.`,
  ...
  celebration: {
    ...
    eg: `The town organized a grand *celebration* to mark its founding anniversary.
Graduation day is a time for *celebration* and reflection on academic achievements.`,
  ...
  creativity: {
    ...
    eg: `Encouraging *creativity* in the workplace fosters innovative ideas and problem-solving.
The art class provided students with the freedom to express their *creativity* through various mediums.`,
  ...
  honesty: {
    ...
    eg: `Maintaining *honesty* in relationships builds trust and strengthens connections.
The employee was commended for his *honesty* in admitting a mistake and taking responsibility.`,
  ...
  optimistic: {
    ...
    eg: `Despite setbacks, she remained *optimistic* and focused on finding solutions.
An *optimistic* outlook can positively impact mental well-being and overall happiness.`,
  ...
  efficiency: {
    ...
    eg: `The new software increased the *efficiency* of the workflow, saving time and resources.
Time management skills contribute to the *efficiency* of completing tasks in a timely manner.`,
  ...
  gratitude: {
    ...
    eg: `Expressing *gratitude* for small gestures creates a positive and appreciative atmosphere.
The festivals are a time for reflection and *gratitude* for the blessings in life.`,
  ...
  adventure: {
    ...
    eg: `Exploring new hiking trails became their favorite *adventure* during weekends.
Embarking on an unplanned road trip added an element of excitement and *adventure* to their journey.`,
  ...
  persistence: {
    ...
    eg: `Success often comes to those who approach challenges with *persistence* and determination.
The author's *persistence* in pursuing publication eventually led to the release of the novel.`,
  ...
  compassion: {
    ...
    eg: `Acts of *compassion*, such as volunteering, contribute to building a more empathetic society.
The nurse demonstrated *compassion* by providing comfort and support to patients.`,
  ...
  innovation: {
    ...
    eg: `The company encourages a culture of *innovation*, fostering the development of groundbreaking ideas.
Technological *innovation* has transformed the way we live and work in the modern world.`,
  ...
  kindness: {
    ...
    eg: `Simple acts of *kindness*, like holding the door for someone, can brighten someone's day.
The teacher emphasized the importance of *kindness* and respect in creating a positive classroom environment.`,
  ...
  hilltop: {
    ...
    eg: `They enjoyed a picnic on the *hilltop*, savoring the panoramic view of the valley below.
The path to the ancient castle led them to a scenic *hilltop* where they could see the entire village.`,
  ...
  amidst: {
    ...
    eg: `The small village nestled *amidst* the mountains had a tranquil and serene atmosphere.
The park was a peaceful oasis *amidst* the bustling city, providing a place for relaxation.`,
  ...
  midway: {
    ...
    eg: `The restaurant is conveniently located *midway* between the two main shopping districts.
The *midway* point of the hiking trail offered a stunning vista of the surrounding landscape.`,
  ...
  peak: {
    ...
    eg: `Reaching the *peak* of the mountain was a challenging but rewarding accomplishment.
The artist's career reached its *peak* when a renowned gallery showcased her work.`,
  ...
  effortlessly: {
    ...
    eg: `The skilled gymnast executed the routine *effortlessly*, showcasing grace and precision.
With years of practice, he learned to play the guitar *effortlessly*, captivating audiences with his music.`,
  ...
  excessively: {
    ...
    eg: `The music at the party was *excessively* loud, prompting some guests to step outside for a quiet conversation.
He tended to worry *excessively* about things that were beyond his control.`,
  ...
  passionately: {
    ...
    eg: `The speaker addressed the audience *passionately*, advocating for environmental conservation.
The couple danced *passionately* under the moonlight, lost in the rhythm of the music.`,
  ...
  incredible: {
    ...
    eg: `The view from the mountaintop was *incredible*.
The scientist made an *incredible* discovery that reshaped our understanding of the natural world.`,
  ...
  endlessly: {
    ...
    eg: `The children played *endlessly* in the backyard, creating imaginary adventures.
The author's creativity seemed to flow *endlessly* as they wrote one captivating story after another.`,
