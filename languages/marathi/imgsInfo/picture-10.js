export default {
  id: 'picture-10',
  label: 'सामाजिक आणि विज्ञान|Social and Science',
  list: [
    {
      id: 'social',
      label: 'सामाजिक विज्ञान|Social Science',
      text: `mountain | डोंगर|Ḍōṅgara
seashore | समुद्रकिनारी|Samudrakinārī
forest | वन|Vana
desert | वाळवंट|Vāḷavaṇṭa
river | नदी|Nadī
grassland | गवताळ प्रदेश|Gavatāḷa pradēśa
ocean | महासागर|Mahāsāgara
polar | ध्रुवीय|Dhruvīya
valley | दरी|Darī
...
pillar | खांब|Khāmba`
    },
    {
      id: 'organs',
      label: 'अवयव|Organs',
      text: `heart|हृदय|Hr̥daya
brain|मेंदू| mēndū
lungs|फुफ्फुसे|phuphphusē
stomach| पोट| pōṭa
liver| यकृत|yakr̥ta
kidney|मूत्रपिंड| mūtrapiṇḍa`
    },
    {
      id: 'teeth',
      label: 'दात|Teeth',
      text: `incisor | पुढचा दात | Puḍhacā dāta
...
molar |दाढ|dāḍha`
    },
    {
      ...
      text: `windmill | पवनचक्की|pavanacakkī
