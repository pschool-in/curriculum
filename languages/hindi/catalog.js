...
Mcq on compound words`
    ...
    {
      label: 'Grammar Practice (व्याकरण अधिक अभ्यास)',
...
Arrange number names in ascending order`
    ...
    {
      label: 'Numbers Practice (गिनती अधिक अभ्यास)',
...
Fill up using synonyms`
    ...
    {
      label: 'Sentence Practice (वाक्य अधिक अभ्यास)',
      id: 'hi-sentence-practice',
      text: `Form sentence activity (more practice)`
    },
    {
...
Fill up based on one word many meanings`
    ...
    {
      label: 'Words Practice (शब्द अधिक अभ्यास)',
      id: 'hi-word-practice',
...
Match synonyms`
    },
    {
      ...
      id: 'hi-wordsearch',
      text: `Wordseach on day of a week
Wordseach on fruits
