export default {
  ...
  list: [
    {
      label: 'Letters (അക്ഷരമാല)',
      id: 'ml-letter',
      text: `Tracing activity on vowels with audio
Tracing activity on consonants with audio
Match animal images with their first letter
Match flower images with their first letter
...
Consonant sounds`
    ...
    {
      label: 'Letter - 2 (അക്ഷരമാല)',
      id: 'ml-letter-2',
      text: `Identify letter based on sound (all consonants with vowel based matras)
Complete the word activity with simple and common words
...
Match activity on days of the week`
    ...
    {
      label: 'Words-2 (വാക്ക്)',
      id: 'ml-word-2',
      text: `Match activity on synonyms
...
Drag and drop activity on parts of body`
    ...
    {
      label: 'Social (സാമൂഹിക ശാസ്ത്രം)',
      id: 'ml-social',
      text: `Map of rivers in Kerala
...
Audio story of mangoes, healthy eating habits, different occupations, the thirsty crow`
    },
    {
      label: 'General Knowledge',
      id: 'ml-gk',
      text: `Reading passage on the different districts in Kerala and their specialties.
Mcq based on the passage
Match the district with its nicknames
Fill up on the districts in Kerala and their specialties
...
Fill up on symbols of Kerala`
    },
    {
      label: 'Kerala',
      id: 'ml-kerala',
      text: `Map of rivers in Kerala in English
Map of districts in Kerala in English`
    },
    {
      label: 'Poems (കവിത)',
      id: 'ml-poem',
      text: `10 easy poems for Kindergarteners`
    },
    {
      label: 'Reading (കഥകൾ)',
      id: 'ml-reading',
      text: `15 traditional tales for children with moral of the story`
    },
    {
      label: 'Riddle (കടങ്കഥകൾ)',
      id: 'ml-riddle',
...
Complete word activity on riddles`
    },
    {
      label: 'Crosswords',
      id: 'ml-crossword',
      text: `Crossword on fruits, simple words, household items, nature, body parts`
    },
    {
      label: 'Wordsearch',
      id: 'ml-wordsearch',
      text: `Wordsearch on animals, birds, fruits with hints, bodyparts with hints, items used in kitchen`
    }
  ]
};
