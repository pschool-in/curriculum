  ...
  list: [
      ...
      data: {
        ...
        source: [
          ...
          },
          {
            ...
            width: 220,
            paths: [
              "M 16 156 C 122 154 54 42 19 122 C 3 164 13 247 121 241 ",
              "M 121 241 C 201 244 212 174 198 140 C 166 50 121 108 142 140 ",
              "M 142 140 C 158 164 208 196 212 245 C 220 302 144 305 104 303 C 19 306 -17 233 20 201 ",
            ],
          },
          {
            id: "എ",
    ...
    },
    {
      data: {
        ...
        showWords: true,
        table: [
          ["ഖ", "വെ", "തി", "അ:", "ഞാ", "യ", "റാ", "ഴ്ച"],
          ["ഴ", "ള്ളി", "അ:", "ങ്ക", "ധ", "ദ", "വ്യാ", "ആ"],
          ["ആ", "യാ", "മ", "ഖ", "ളാ", "ഴാ", "ഢ", "ഖ"],
          ["ങ", "ഴ്ച", "ബ", "ഓ", "ഴ്ച", "ഴ്ച", "ഘ", "ഋ"],
          ["ഋ", "ബു", "ധ", "നാ", "ഴ്ച", "ഗ", "ഢ", "യ"],
          ["സ", "പ", "ഔ", "ണ", "ഘ", "ദ", "ല", "ഊ"],
          ["ല", "ഉ", "ണ", "ദ", "ശ", "നി", "യാ", "ഴ്ച"],
          ["ചൊ", "വ്വാ", "ഴ്ച", "ഥ", "യ", "ഊ", "ഷ", "ക"],
        ],
    ...
    },
    {
      data: {
        text:
          "ഭരണി,ബരണി\nഷർട്ട്, ഷർറ്റ്\nവിളക്ക്,വിഴക്ക്\nപാവാട,പാവാഠ\nപറവ,പരവ\nഅരണ, അരന\nമുതല,മുദല\nതൊപ്പി,തൊപി\nകിടക്ക,കിടക\nബക്കറ്റ്,ഭക്കറ്റ്\nതവള,തവഴ\nആകാശം,ആഖാശം\nഗരുഡൻ,ഖരുഠൻ\nചവിട്ടി, ഛവിട്ടി",
        title: "ശരിയായ അക്ഷരവിന്യാസം  തിരഞ്ഞെടുക്കുക",
      },
      id: "1604246276884",
      label: " ശരിയായ അക്ഷരവിന്യാസം",
      slug: "correct-spelling-template",
      type: "rightOne",
    },
    {
      data: {
        text:
          "വെ ണ്ട ക്കാ യ,  ചെ മ്പ ര ത്തി, ഗ രു ഡ ൻ, ത ണ്ണി മ ത്ത ന്‍, ഏ ത്ത പ്പ ഴം, സൂ ര്യ കാ ന്തി, പേ ര യ് ‌ക്ക, കൈ ത ച്ച ക്ക, ത ക്കാ ളി, പൂ വ ന്‍ കോ ഴി, വേ ഴാ മ്പ ല്‍, കു റു ക്ക ന്‍, പു ളളി പ്പു ലി, ജി റാ ഫ്‌, ക ര ടി\n",
        title: "Connect the blocks to form meaningful word.",
      },
      editable: true,
      id: "1604246118236",
    ...
    },
    {
      data: {
        ...
        text: "താ, മര\nവാ, തിൽ\nതൂ, വൽ\nകു, പ്പി\nകാ, ക്ക\nഭൂ, മി\nഭാ, രതം",
        title: "Match to form a meaningful word.",
      },
      editable: true,
      id: "1604247703086",
      label: "Match and form words - 1",
    ...
    },
    {
      data: {
        ...
        title: "നൽകിയ വാക്കുകൾ പട്ടികയിൽ നിന്ന് കണ്ടെത്തുക.",
        words: [
          {
            marker: [0, 1, 2, 1],
            word: ["കു", "തി", "ര"],
