...
## Chapter: maha g3: Sensory Organs
...
## Fill in the blanks (using options)
```
If we cannot see well, we can use *spectacles (walking stick)*.
...
False:
Disabilities cannot be overcome.
Eyes help to smell.
Sign language is used by blind.
```
## Choose the correct answer. (mcq)
```
Our eyes tell us how __________ something is.
far, tasty, smelly

Our ears tell us which direction a _________ is coming from.
sound, smell, breeze

The smell tells us that the air is _________.
foul, colourless, harsh 

Our ________ tells us that something is hot.
skin, tongue, touch 
