  ...
  list: [
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: 'Who wanted to expand the army?',
            options: 'The king, Tenali Raman, The people, The soldiers'
          },
          {
            qText: 'What did the king require to expand his army?',
            options: 'Horses, Elephants, Soldiers, Cows'
          },
          {
            qText: 'How did Tenali Raman treated his horse?',
            options: `He gave very little straw
          ...
          {
            qText: 'The horse was fed through a ________.',
            options: 'window, door, hole'
          },
          {
            qText: 'The chief inspector had a long ________.',
            options: 'beard, hair, mustache, nose'
          }
        ]
      }
    },
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: 'Who caused the major problem in the country?',
            options: `Cows
            Cats
            * Rats
            All of the above`
          ...
          {
            qText: 'How did the king solve the country’s major problem?',
            options: `By asking people to keep a cat.
            By collecting tax from people.
            By giving money to people.
            By asking people to keep a cow.`
          },
          {
            qText: "Who drank the cow's milk in Tenali Raman’s house?",
            options: `Tenali Raman, Cat, Rat, Calf`
          },
          {
            qText: "When brought for inspection, Tenali's cat was __________.",
            options:
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: 'Where does the story take place?',
            options: 'In a grocery shop, In a house, In a school, In a hotel'
          },
          {
            qText: 'The story revolves around ________.',
            options:
              'a group of mice, a group of cats, a crowd of people, a flight of doves'
          },
          {
            qText: 'What did the shop owner buy to solve his problem?',
            options: 'A big cat, A big bell, A big dog, A mouse trap'
          },
          {
            qText: 'What caused the mice to worry?',
            options: `They could not reach the food anymore.
              They could not come out of their hole freely anymore.
              They could not live happily in the grocer’s shop anymore
              * All of the above`
          },
          {
            qText: 'Who wanted to hang the bell around the cat’s neck?',
            options:
        ...
        questions: [
          {
            ...
            options: 'into a village, to a mountain, into a forest'
          },
          {
            qText: 'Who chased the jackal in the village?',
            options:
              'A pack of dogs, A herd of elephants, A pride of lions, A gang of buffaloes'
          },
          {
            qText: 'Where did the jackal fell?',
            options: 'Into a blue dye tub, Into a well, Into a pit'
          },
          {
            qText:
              'What was the feeling of other animals on seeing the blue jackal?',
            options: 'shock, sad, angry, happy'
          },
          {
            qText:
              'One day, the identity of the jackal was revealed by its ______.',
            options: 'howling, barking, yelling, roaring'
          }
        ]
      }
    },
    ...
    },
    {
      ...
      data: {
        ...
        questions: [
          {
            qText: 'What caused the lake to dry?',
            options:
              'The scorching summer sun, The three friends, The fishes in the lake'
          },
          {
            qText: 'Why did the geese pick a stick?',
            options: `The tortoise cannot fly.
            The lake was drying.
            The stick was beautiful.`
          },
          {
            qText: 'What was the condition given by geese?',
            options: `The tortoise should not talk.
              The tortoise should close its eye.
              The tortoise should not jump.`
          },
          {
            qText: 'What did the other animals laughed at?',
            options:
              'A flying tortoise, A flying goose, A drying lake, An ugly stick'
          },
          {
            qText: 'The tortoise was saved because ________.',
            options: `of its thick shell, it had strong legs, it fell on a soft land`
          }
        ]
      }
    },
